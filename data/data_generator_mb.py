...
parser.add_argument("--input-dir", type=str,
                    default="../gnnet-ch23-dataset-mb")
parser.add_argument("--output-dir", type=str,
                    default="../data_modify/data_mb_ibg_onRate")
        ...
        for local_flow_id in range(len(traffic_matrix[src, dst]["Flows"])):
            ...
            flows[flow_id] = {
                ...
                * 1000,  # in ms
                ...
                # new change
                # add new features: on_rate and ibg
                "on_rate":flow['TimeDistParams']['On_Rate'],
...
def _generator(
    ...
    for sample in iter(tool):
        ret ,sample_max_burst_num= _get_network_decomposition(sample)
