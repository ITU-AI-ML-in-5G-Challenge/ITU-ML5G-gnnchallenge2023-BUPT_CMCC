...
if __name__ == "__main__":
    ...
    # new change
    # load CBR+MB model
    cbr_mb_model = models.Baseline_cbr_mb()
    cbr_mb_ckpt_path = "./ckpt/cbr_mb_model"
    cbr_mb_tr_path = "./data/data_cbr_mb_ipg_onRate"
    cbr_mb_model.set_min_max_scores(
        get_min_max_dict(
    ...
    mb_ckpt_path = "./ckpt/mb_model"
    mb_tr_path = "./data/data_mb_ibg_onRate"
